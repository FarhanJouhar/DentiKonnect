...
def diagnosis_tab(notebook):
    ...
    hpi_label = tk.Label(left_data_frame, text="History of Present Illness:")
    ...
    pmh_label = tk.Label(left_data_frame, text="Past Medical History:")
    ...
    ph_label = tk.Label(left_data_frame, text="Personal History:")
