...
def diagnosis_tab(notebook):
    ...
    complaint_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
    ...
    hpi_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
    ...
    pmh_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
    ...
    ph_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
    ...
    pd_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
    ...
    fd_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
    ...
    tp_field = tk.Text(left_data_frame, state="normal", height=4, width=38, background=Medical_BG, foreground=Text_Colour)
